          ...
          <div className="box card p-3 shadow border-0">
            ...
            <form action="" className="mt-3">
              ...
              <div className="d-flex align-items-center mt-3 mb-3 ">
                ...
                <Link to="/"><Button onClick={()=>context.setisHeaderFooterShow(true)} className="btn-lg btn-big col ml-3" variant="outlined">
                  Cancel
                </Button></Link>
              </div>
              ...
              <p>
                Not Registered?
                <Link to="/signIn" className="border-effect cursor ml-1">
                  Sign In
                </Link>
              </p>
